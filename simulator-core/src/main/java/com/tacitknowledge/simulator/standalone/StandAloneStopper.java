...
public class StandAloneStopper {
	 ...
	 * 
	 */
	int closePort = CloseCommandWaiter.DEFAULT_CLOSE_PORT;
	String closeCommand = CloseCommandWaiter.DEFAULT_CLOSE_COMMAND;
	/**
	 * class logger
	 */
	...
	private void loadConfiguration()
	{
		...
		{
			this.closePort = Integer.parseInt(bundle.getString(CloseCommandWaiter.CLOSE_PORT_NAME));
		}
		
		if(bundle.containsKey(CloseCommandWaiter.CLOSE_COMMAND_NAME))
		{
			this.closeCommand = bundle.getString(CloseCommandWaiter.CLOSE_COMMAND_NAME);
		}
	}
	/**
